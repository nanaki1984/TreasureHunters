...
BitStream::BitStream(Memory::Allocator &_allocator)
...
BitStream::BitStream(Memory::Allocator &_allocator, size_t initialSize)
: allocator(&_allocator)
{
...
BitStream::BitStream(Memory::Allocator &_allocator, const void *_data, size_t dataLength, bool _copyData)
: allocator(&_allocator),
  copyData (_copyData)
{
