...
private:
    ...
    bool ReadBit() const;
public:
    BitStream(Memory::Allocator &_allocator);
    BitStream(const BitStream &stream);
    BitStream(BitStream &&stream);
    BitStream(Memory::Allocator &_allocator, size_t initialSize);
    BitStream(Memory::Allocator &_allocator, const void *_data, size_t dataLength, bool _copyData = true);
    ~BitStream();
...
template <>
inline BitStream&
BitStream::operator <<(const std::string &value)
{
...
template <>
inline BitStream&
BitStream::operator <<(const Core::String &value)
{
...
BitStream::operator >>(BitStream &value) const
{
    ...
    auto &scratchAlloc = Memory::GetAllocator<Memory::ScratchAllocator>();
...
template <>
inline const BitStream&
BitStream::operator >>(std::string &value) const
{
...
template <>
inline const BitStream&
BitStream::operator >>(Core::String &value) const
{
    uint32_t sz;
    (*this) >> sz;
    value.Clear();
